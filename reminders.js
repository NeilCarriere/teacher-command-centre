(function(){
  ...
  function install(){
    ...
    style.textContent=`
      ...
      .reminder-form{display:grid;grid-template-columns:155px minmax(260px,1fr) auto;gap:10px;align-items:end;margin-bottom:11px}
      .reminder-field{display:grid;gap:4px}.reminder-field label{font-family:"Trebuchet MS",sans-serif;font-size:12px;font-weight:900;color:#1f241f;letter-spacing:.02em}.reminder-field input{width:100%;box-sizing:border-box;background:rgba(255,255,255,.62);border:1px solid rgba(31,36,31,.35);color:#1f241f;padding:10px 11px;border-radius:7px;font:600 14px "Trebuchet MS",sans-serif}.reminder-text-input{min-height:42px}.reminder-field input:focus{outline:2px solid rgba(31,36,31,.38);outline-offset:1px;background:rgba(255,255,255,.78)}
      .reminder-form button{border:1px solid rgba(31,36,31,.35);background:rgba(31,36,31,.14);color:#1f241f;border-radius:8px;padding:10px 13px;font-weight:900;cursor:pointer;min-height:42px}.reminder-form button:hover{background:rgba(31,36,31,.22)}
      .reminder-help{grid-column:1/-1;font-family:"Trebuchet MS",sans-serif;font-size:11px;opacity:.72;margin-top:-2px}
      ...
      @media(max-width:700px){.reminder-form{grid-template-columns:1fr}.reminder-form>*{width:100%}.reminder-help{grid-column:1}}
    `;
